...
echo "     - every file needs an id: (classes/interfaces UUIDv5(NIL, Name); others UUIDv4)"
echo "     - base lacks something? declare <Vendor><Base>Base extends <Base> HERE, never edit base"
